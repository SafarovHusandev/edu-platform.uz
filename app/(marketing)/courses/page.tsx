...
function CoursesCatalog() {
  ...
  const isAnyFilterActive = Boolean(initialSearch || category || priceFilter !== "all" || sortBy !== "default")
  const selectedCategoryName = categories?.find((c) => c._id === category)?.name

  return (
    <div className="min-h-screen pb-20">
      {/* Hero / Header Section */}
      <div className="relative overflow-hidden border-b border-border/60 bg-gradient-to-b from-primary/5 via-background to-background py-12 sm:py-16">
        <div
          aria-hidden
        ...
        <Container className="flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3.5 py-1 text-xs font-medium text-primary shadow-xs backdrop-blur-md">
            <Sparkles className="size-3.5" />
            <span>Eng so&apos;nggi va sifatli ta&apos;lim kurslari</span>
          </div>

          <h1 className="mt-4 max-w-3xl text-balance font-heading text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
          ...
          <p className="mt-3 max-w-2xl text-balance text-sm text-muted-foreground sm:text-base">
            Dasturlash, dizayn, xorijiy tillar va boshqa zamonaviy sohalar bo&apos;yicha amaliy darslar, topshiriqlar hamda rasmiy sertifikatlar.
          </p>

          {/* Quick Value Props */}
          <div className="mt-6 flex flex-wrap items-center justify-center gap-2.5 sm:gap-4">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-border/70 bg-card/80 px-3 py-1 text-xs font-medium text-muted-foreground shadow-xs backdrop-blur-xs">
      ...
      <Container className="pt-8">
        ...
        <div className="mb-6">
          <div className="no-scrollbar flex items-center gap-2 overflow-x-auto pb-2">
            <button
              ...
              className={`inline-flex shrink-0 items-center gap-1.5 rounded-full px-4 py-2 text-xs font-medium transition-all duration-200 ${
                !category
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
            ...
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="h-11 rounded-xl bg-background pl-10 pr-9 text-sm shadow-none focus-visible:ring-2 focus-visible:ring-primary/40"
              />
              {searchInput && (
                <button
                  type="button"
            ...
            <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
              ...
              <div className="flex rounded-xl border border-border bg-background p-0.5 text-xs font-medium">
                <button
                  type="button"
              ...
              >
                <SelectTrigger className="h-10 w-44 rounded-xl border-border bg-background px-3 text-xs">
        ...
        {isLoading ? (
          ...
          <div
            className={
              isPlaceholderData
                ? "grid gap-6 opacity-60 transition-opacity sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
          ...
          <div className="relative overflow-hidden rounded-3xl border border-dashed border-border/80 bg-card/50 px-6 py-16 text-center backdrop-blur-xs sm:py-24">
            ...
            <p className="mx-auto mt-1.5 max-w-md text-sm text-muted-foreground">
              Qidiruv so&apos;zini o&apos;zgartirib ko&apos;ring yoki filtrlarni tozalab boshqatdan qidirib ko&apos;ring.
            </p>
            {isAnyFilterActive && (
