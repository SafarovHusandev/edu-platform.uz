      ...
      {items.map((item) => {
        ...
        return (
          <Link
            ...
            onClick={onNavigate}
            className={cn(
              "group flex items-center gap-2.5 rounded-xl px-3.5 py-2.5 text-sm font-medium text-muted-foreground transition-all duration-200 ease-out hover:translate-x-0.5 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
